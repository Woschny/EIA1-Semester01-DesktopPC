...
//Special Keys
document.querySelector("#playbutton").addEventListener("click", function (): void {Beat(); });
document.querySelector("#deletebutton").addEventListener("click", function (): void {Delete(); });
