...
window.addEventListener("load", function () {
    ...
    var link = ['assets/A.mp3', 'assets/G.mp3', 'assets/F.mp3', 'assets/C.mp3', 'assets/hihat.mp3', 'assets/kick.mp3', 'assets/snare.mp3', 'assets/laugh-1.mp3', 'assets/laugh-2.mp3', 'assets/.mp3'];
    var order = ['assets/snare.mp3', 'assets/kick.mp3', 'assets/hihat.mp3', 'assets/snare.mp3'];
    var key = 0;
